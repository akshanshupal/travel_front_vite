...
import { getBookingtypeById, updateBookingById } from "@/utils/services/bookingTypeService";
...
export default function BookingTypeEditPage() {
        ...
        const run = async () => {
            ...
            try {
                ...
                setForm({
                    ...
                    additionalDetails: ensureFields(resolved?.customParams?.additionalDetails),
                    additionalBookingDetails: ensureFields(resolved?.customParams?.additionalBookingDetails),
                });
            } catch (error: any) {
                showSnackbar({
                    title: "Error",
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await updateBookingById(id, payload);
            if (response?.error) {
                throw new Error(response.error);
            }
            showSnackbar({
                title: "Success",
                description: "Booking type updated",
                color: "success",
            });
            ...
            showSnackbar({
                title: "Error",
                description: error?.message || "Failed to update booking type",
                color: "danger",
            });
        } finally {
            setSaving(false);
