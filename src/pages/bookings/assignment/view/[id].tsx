        ...
        const exportData = [
            {
                ...
                "Land Package Amount": data?.landPackageAmount ?? "",
                "Land Package GST (%)": data?.landPackageGstPercentage ?? "",
                "Land Package GST Amount": data?.landPackageGstAmount ?? "",
                "Train / Flight / Bus Amount": data?.transportPackageAmount ?? "",
                "Train / Flight / Bus GST (%)": data?.transportPackageGstPercentage ?? "",
                "Train / Flight / Bus GST Amount": data?.transportPackageGstAmount ?? "",
