...
const routes = [
    ...
    "/lead-management/leads/add",
    "/lead-management/leads/view/1",
    "/lead-management/leads/edit/1",
    "/lead-management/pipeline",
    "/lead-management/pipeline/add",
    "/lead-management/pipeline/view/1",
    "/lead-management/pipeline/edit/1",
    "/lead-management/campaign",
    "/lead-management/campaign/add",
    "/lead-management/campaign/view/1",
    "/lead-management/campaign/edit/1",
    "/lead-management/settings",
    "/lead-management/settings/contact-properties",
    "/lead-management/settings/contact-properties/add",
    "/lead-management/settings/contact-properties/edit/1",
    "/packages/list",
    ...
    "/additional-data/settings/package-inclusions",
    "/additional-data/settings/package-exclusions",
    "/settings/user",
    ...
    "/additional-data/settings/template",
    "/additional-data/settings/template/template-one",
    "/package-mail/1",
    "/package-voucher/1",
    "/payments-receipt/1",
    "/hotel-images/1",
