...
export default function ItineraryHotelCategoryAddPage() {
    ...
    const canSave = useMemo(() => {
        ...
        return true;
    }, [featureImgFile, form.alias, form.description, form.title]);
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            useStoreSnackbar.getState().showSnackbar({ title: "Success", description: "Category created", color: "success" });
            navigate("/itinerary/hotel/category");
        } catch (e: any) {
            useStoreSnackbar.getState().showSnackbar({ title: "Error", description: e?.message || "Failed to create category", color: "danger" });
        } finally {
            setSaving(false);
        }
    };
