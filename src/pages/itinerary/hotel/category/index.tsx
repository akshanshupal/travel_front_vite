...
export default function ItineraryHotelCategoryListPage() {
    ...
    const [tempFilters, setTempFilters] = useState({ title: initial.title, status: initial.status });
    ...
    const columns = [
        { id: "index", name: "S. No.", widthRatio: 8, minWidth: 64 },
        { id: "title", name: "Title", widthRatio: 34, minWidth: 200 },
        { id: "alias", name: "Alias", widthRatio: 24, minWidth: 180 },
                    ...
                    <TableCard.Header
                        ...
                        contentTrailing={
                            <div className="flex w-full flex-col gap-2 md:w-auto md:flex-row md:items-center">
                                ...
                                <Button size="sm" color="primary" iconLeading={Plus} onClick={() => navigate("/itinerary/hotel/category/add")}>
                                    Add Category
                                </Button>
                            </div>
                        }
                                    ...
                                    {(column) => (
                                        ...
                                        >
                                            {column.id === "index" ? (
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={() => navigate(`/itinerary/hotel/category/view/${item.id}`)}
                                                ...
                                                <div className="flex w-full items-center justify-end gap-1.5">
                                                    <ButtonUtility
                                                        ...
                                                        icon={Edit01}
                                                        onClick={() => navigate(`/itinerary/hotel/category/edit/${item.id}`)}
                                                        color="warning"
                                                    />
                                                    <ButtonUtility
                                                        tooltip="Delete"
                        ...
                        <Dialog>
                            <div className="relative w-full rounded-xl bg-primary p-5 ring-1 ring-secondary">
                                ...
                                <div className="space-y-1">
                                    <h2 className="text-lg font-semibold text-primary">Delete category</h2>
                                    <p className="text-sm text-tertiary">
                                        {deleteTarget?.title ? `Delete "${deleteTarget.title}"?` : "Delete this category?"}
                                    </p>
                                </div>
