...
export default function ItineraryHotelCategoryViewPage() {
        ...
        return (
            <DefaultLayout>
                ...
                <div className="rounded-xl border border-error-solid bg-error-bg p-6 text-error-text">
                    ...
                    <Button className="mt-4" size="sm" color="secondary" onClick={() => navigate("/itinerary/hotel/category")}>
                        Go Back
                    </Button>
                </div>
            </DefaultLayout>
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col gap-4 border-b border-secondary bg-primary px-6 py-5 md:flex-row md:items-start md:justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button color="primary" iconLeading={Edit01} onClick={() => navigate(`/itinerary/hotel/category/edit/${id}`)}>
                            Edit Category
                        </Button>
                    </div>
                </div>
