...
export default function ItineraryAreaViewPage() {
        ...
        return (
            <DefaultLayout>
                ...
                <div className="rounded-xl border border-error-solid bg-error-bg p-6 text-error-text">
                    <p className="font-semibold">Error loading area</p>
                    <p className="text-sm">{loadError}</p>
                    <Button className="mt-4" size="sm" color="secondary" onClick={() => navigate("/itinerary/area")}>
                        Go Back
                    </Button>
                </div>
            </DefaultLayout>
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col gap-4 border-b border-secondary bg-primary px-6 py-5 md:flex-row md:items-start md:justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button color="primary" iconLeading={Edit01} onClick={() => navigate(`/itinerary/area/edit/${id}`)}>
                            Edit Area
                        </Button>
                    </div>
                </div>
