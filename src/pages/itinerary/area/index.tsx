                    ...
                    <TableCard.Header
                        ...
                        contentTrailing={
                            <div className="flex w-full flex-col gap-2 md:w-auto md:flex-row md:items-center">
                                ...
                                <Button size="sm" color="primary" iconLeading={Plus} onClick={() => navigate("/itinerary/area/add")}>
                                    Add Area
                                </Button>
                            </div>
                        }
                                    ...
                                    {(column) => (
                                        ...
                                        >
                                            {column.id === "index" ? (
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={() => navigate(`/itinerary/area/view/${item.id}`)}
                                                ...
                                                <div className="flex w-full items-center justify-end gap-1.5">
                                                    ...
                                                    <ButtonUtility
                                                        ...
                                                        tooltipPlacement="bottom"
                                                        icon={Edit01}
                                                        onClick={() => navigate(`/itinerary/area/edit/${item.id}`)}
                                                        color="warning"
                                                    />
                                                    <ButtonUtility
                                                        tooltip="Delete"
                    ...
                    <Modal className="max-w-lg">
                        <Dialog>
                            <div className="relative w-full rounded-xl bg-primary p-5 ring-1 ring-secondary">
                                <CloseButton onPress={() => state.close()} className="absolute right-4 top-4" size="sm" />
                                <div className="space-y-1">
                                    <h2 className="text-lg font-semibold text-primary">Delete area</h2>
                                    <p className="text-sm text-tertiary">
                                        {deleteTarget?.title ? `Delete "${deleteTarget.title}"?` : "Delete this area?"}
                                    </p>
                                </div>
                                <div className="mt-5 flex justify-end gap-2">
                                    <Button color="secondary" onClick={() => state.close()}>
