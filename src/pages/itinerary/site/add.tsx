...
export default function ItinerarySiteAddPage() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            useStoreSnackbar.getState().showSnackbar({ title: "Success", description: "Site created", color: "success" });
            navigate("/itinerary/site");
        } catch (e: any) {
            useStoreSnackbar.getState().showSnackbar({ title: "Error", description: e?.message || "Failed to create site", color: "danger" });
        } finally {
            setSaving(false);
        }
    };
