...
import { getPhotographyPaymentStoreById } from "@/utils/services/photographyPaymentStoreService";
                ...
                <TableCard.Header
                    ...
                    contentTrailing={
                        <div className="flex w-full flex-col gap-2 md:w-auto md:flex-row md:items-center md:justify-end">
                            ...
                            <Button color="primary" iconLeading={Edit01} onClick={() => navigate(`/photography/paymentStore/edit/${id}`)}>
                                Edit
                            </Button>
                        </div>
                    }
