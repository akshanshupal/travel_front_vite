...
export default function PhotographyPaymentPage() {
    ...
    const columns = [
        { id: "bookingNumber", name: "Booking", widthRatio: 16, minWidth: 160 },
        { id: "estimate", name: "Estimate", widthRatio: 16, minWidth: 160 },
        { id: "client", name: "Client", widthRatio: 18, minWidth: 180 },
        { id: "createdAt", name: "Created", widthRatio: 14, minWidth: 140 },
                    ...
                    <TableCard.Header
                        ...
                        contentTrailing={
                            <div className="flex w-full flex-col gap-2 md:w-auto md:flex-row md:items-center">
                                <Button color="secondary" onClick={() => navigate("/photography/bookings")}>
                                    Go To Bookings
                                </Button>
                            </div>
                        }
                                            ...
                                            {column.id === "bookingNumber" ? (
                                                ...
                                                <div className="flex w-full items-center justify-end gap-1.5">
                                                    <ButtonUtility
                                                        ...
                                                        icon={Eye}
                                                        onClick={() => navigate(`/photography/payments/view/${item.id}`)}
                                                        color="brand"
                                                    />
                                                </div>
                                            )}
