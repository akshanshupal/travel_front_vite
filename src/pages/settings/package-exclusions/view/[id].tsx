        ...
        return (
            <DefaultLayout>
                <div className="flex min-h-[320px] flex-col items-center justify-center gap-3">
                    <p className="text-base font-medium text-primary">Package exclusion not found.</p>
                    <Button color="secondary" onClick={() => navigate("/additional-data/settings/package-exclusions")}>
                        Back to List
                    </Button>
                </div>
            </DefaultLayout>
                    ...
                    <TableCard.Header
                        ...
                        contentTrailing={
                            <div className="flex w-full flex-col gap-2 md:w-auto md:flex-row md:items-center md:justify-end">
                                ...
                                <Button color="primary" iconLeading={Edit01} isDisabled={!canEdit} onClick={() => navigate(`/additional-data/settings/package-exclusions/edit/${id}`)}>
                                    Edit
                                </Button>
                            </div>
                        }
