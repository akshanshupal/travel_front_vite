...
export const NavAccountMenu = ({
    ...
    const logout = useStoreLogin((s) => s.logout);
    const userId = storeUser?.id;
    const userProfileHref = userId ? `/settings/user/${userId}` : "/settings/user";
                    ...
                    <div className="rounded-xl bg-primary ring-1 ring-secondary">
                        <div className="px-3 pt-3 pb-2">
                            <AvatarLabelGroup
                                ...
                                size="md"
                                src={undefined}
                                initials={getInitials(storeUser?.name || "")}
...
export const NavAccountCard = ({
    ...
    const storeUser = useStoreLogin((s) => s.user);
    const selectedAccount = storeUser?.id
        ? ({
              id: storeUser.id,
              name: storeUser.name,
    ...
    return (
        <div ref={triggerRef} className="relative flex items-center gap-3 rounded-xl p-3 ring-1 ring-secondary ring-inset">
            <AvatarLabelGroup
                ...
                initials={getInitials(selectedAccount.name)}
